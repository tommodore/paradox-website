...
2. **Hero**  
   ...
   Subheadline: “Until you look.” / “Fins que mires.”  
   Strong call-to-action to the interactive experiment.

3. **The Paradox**  
   Short, poetic explanation of Schrödinger’s cat (bilingual).  
...
4. **The Experiment** (the heart of the page)  
   ...
   - Big “Observe” / “Observa” button  
   - On click: The superposition collapses (random alive/dead result)  
   - Poetic bilingual result message appears  
   - Subtle particle effects and screen flash

5. **Famous Paradoxes** (3–4 cards max)  
   Short bilingual cards (Zeno’s, Fermi, Ship of Theseus, Grandfather Paradox).  
   Keep descriptions elegant and concise.

6. **Reflections** (optional short section)  
   2–3 poetic bilingual thoughts on uncertainty and observation.

7. **Footer**  
   Simple with language note and copyright.

---

## Language Guidelines

- All main text must appear in both English and Catalan.  
- Use a prominent language switcher in the navbar that instantly changes the entire page content.  
- Keep the interactive experiment results bilingual (e.g. “The cat is alive.” / “El gat és viu.”).  
- Use natural, beautiful Catalan translations.
...
“Build only a landing page for paradox.cat as described in Agents.md. Make it elegant, mysterious, and centered on Schrödinger’s cat uncertainty. Support English and Catalan with a clean language switcher. Keep the interactive observation experiment as the highlight.”
